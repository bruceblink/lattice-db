...
/// Returns the initial version and capacity values used by the stage 0 validator.
...
mod tests {
    ...
    #[test]
    fn stage_zero_baseline_is_valid() {
    ...
    #[test]
    fn rejects_unsupported_file_format_version() {
        let mut baseline = stage_zero_baseline();
    ...
    #[test]
    fn rejects_zero_record_capacity() {
        let mut baseline = stage_zero_baseline();
    ...
    #[test]
    fn rejects_batch_smaller_than_record() {
        let mut baseline = stage_zero_baseline();
